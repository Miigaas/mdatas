...
<div class="card">
    <h5 class="card-header">Ангилал нэмэх</h5>
    <div class="card-body">
      <form method="post" action="{{route('category.store')}}">
        {{csrf_field()}}
        <div class="form-group">
          <label for="inputTitle" class="col-form-label">Гарчиг <span class="text-danger">*</span></label>
          <input id="inputTitle" type="text" name="title" placeholder="Ангилал оруулах"  value="{{old('title')}}" class="form-control">
          @error('title')
        ...
        <div class="form-group">
          ...
          <input type="checkbox" name='is_parent' id='is_parent' value='1' checked> Тийм
        </div>
        {{-- {{$parent_cats}} --}}

        <div class="form-group d-none" id='parent_cat_div'>
          <label for="parent_id">Үндсэн ангилал</label>
